function[chain_code,oringin,endpoint] = gui_chain_code_func20221129(axis_info,oringin_ori)%user_point
...
% numofpoints = 1;
numofpoints = 1;
contour_points(numofpoints,:) = [rowidxst, colidxst];%起点
...
%     disp(numofpoints)
%     disp(22222)
%     if(numofpoints > 2  && (colidx == colidxst))
%         disp(2)
%     end
...
oringin = oringin_ori;
% figure;
% viewdata = axis_info_ori(rowidxpre-100:rowidxpre+100,colidxpre-100:colidxpre+100);
% imshow(viewdata);
% figure;
% viewdata = axis_info(rowidxpre-100:rowidxpre+100,colidxpre-100:colidxpre+100);
% imshow(viewdata);
